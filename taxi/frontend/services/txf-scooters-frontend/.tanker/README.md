...
Переводы находятся в [Танкере](https://tanker.yandex-team.ru/project/txf-scooters-frontend).

Для работы с переводами на уровне кода используется утилита [i18n](https://a.yandex-team.ru/arc_vcs/frontend/packages/i18n)

Для создания ключей в Танкере и выгрузки переводов, используется [tanker-kit](https://a.yandex-team.ru/arc_vcs/frontend/packages/tanker-kit)
...
```bash
export TANKER_API_TOKEN=<your tanker token>
```
