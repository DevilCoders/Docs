# Фронтенд сервиса Тарифы Яндекс Доставки
...
* NGINX - [newbiz-logistics-frontend-tariffs](/services/newbiz-logistics-frontend-tariffs/etc/nginx/sites-available/newbiz-logistics-frontend-tariffs.conf)
* unstable - [TODO](host)
* testing - [TODO](host)
* stable - [TODO](host)
...
- `cd services/newbiz-logistics-frontend-tariffs/`
- `npm run install`
- `npm start`
