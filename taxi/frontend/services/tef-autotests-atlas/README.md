...
arc mount --mount=/Users/$USER/arcprojects/tef-autotests-atlas --store=/Users/$USER/arc/tef-autotests-atlas --path-filter=taxi/frontend/services/tef-autotests-atlas
```
