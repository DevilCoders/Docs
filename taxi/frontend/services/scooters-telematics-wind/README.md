# Фронтенд сервиса Scooters wind telematics
...
* NGINX - [scooters-telematics-wind](/services/scooters-telematics-wind/etc/nginx/sites-available/scooters-telematics-wind.conf)
* unstable - [TODO](host)
* testing - [TODO](host)
* stable - [TODO](host)
...
- `cd services/scooters-telematics-wind/`
- `npm run install`
- `npm start`
