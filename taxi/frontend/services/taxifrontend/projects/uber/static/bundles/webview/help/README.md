...
`/help?authToken={AUTH}&helpType=Uber&id={ID}`

_AUTH и ID достаём из логов админки_

- Тестирование последней поездки и чека
`/help?id=3e9313c5ca9643269fb1cfda1f8443ca&authToken=AQAAAADu4EeyAAAIgVjV1QZXc0bCjoMUlz4V-bU&helpType=Uber&tripId=1512567229%3Adf506d52e4d54957a2e127456e8045f5`
