...
[Условия использования сервиса «API Яндекс.Такси для партнеров сервиса»](https://yandex.ru/legal/taxi_api_partners/)

Любые вопросы связанные с API можно задать по адресу [api-taxi@yandex-team.ru](mailto:api-taxi@yandex-team.ru).
