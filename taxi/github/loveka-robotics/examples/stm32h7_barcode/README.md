...
Scanner: UART Barcode Scanner by Aliexpress
Breadboard: London Demo

### Description
This project demonstrates how to use
London Demo board with barcode scanners and NUCLEO H7.
...
### More
See wiki https://wiki.yandex-team.ru/lavka/dev/robolab/barcode-scanner/
