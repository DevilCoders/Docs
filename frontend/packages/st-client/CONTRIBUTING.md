...
Этот документ описывает некоторые положения о совместной работе над проектом st-client.

Мейнтейнер проекта — Максим Пономарев ([@maxpon](https://staff.yandex-team.ru/maxpon)).

Проект развивается с помощью сообщества. Мейнтейнер мерджит пулл-реквесты, исправляет особо критичные баги.

## Пулл-реквесты

Если вы что-то исправили или добавили в проект st-client, вы можете отправить пулл-реквест. Он будет рассмотрен мейнтейнером и, либо принят, либо прокомментирован для дальнейшей доработки, либо отклонен.
