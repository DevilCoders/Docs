...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/sakhalin/burger-menu.touch-phone');
...
const scriptSrc = `${staticData.BASE_PATH}sakhalin/burger-menu/burger-menu-base.touch-phone.client.js`
```
