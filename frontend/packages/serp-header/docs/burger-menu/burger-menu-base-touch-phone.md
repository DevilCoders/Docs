...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/base/burger-menu.touch-phone');
...
const scriptSrc = `${staticData.BASE_PATH}base/burger-menu/burger-menu-base.touch-phone.client.js`
```
