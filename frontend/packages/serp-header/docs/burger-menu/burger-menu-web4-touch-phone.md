...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/web4/burger-menu.touch-phone');
...
const scriptSrc = `${staticData.BASE_PATH}web4/burger-menu/burger-menu-base.touch-phone.client.js`
```
