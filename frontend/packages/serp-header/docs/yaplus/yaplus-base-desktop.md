...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/base/yaplus.desktop');
...
const scriptSrc = `${staticData.BASE_PATH}base/yaplus/yaplus-base.desktop.client.js`
```
...
`YENV=testing block=yaplus platform=desktop npm run build:dev`
