...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/tools/notifier.touch-phone');
...
const scriptSrc = `${staticData.BASE_PATH}tools/notifier/notifier-base.touch-phone.client.js`
```
