...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/tools/notifier.desktop');
...
const scriptSrc = `${staticData.BASE_PATH}tools/notifier/notifier-base.desktop.client.js`
```
