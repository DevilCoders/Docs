...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/base/notifier.desktop');
...
const scriptSrc = `${staticData.BASE_PATH}base/notifier/notifier-base.desktop.client.js`
```
