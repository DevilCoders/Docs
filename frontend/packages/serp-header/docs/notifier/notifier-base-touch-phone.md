...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/base/notifier.touch-phone');
...
const scriptSrc = `${staticData.BASE_PATH}base/notifier/notifier-base.touch-phone.client.js`
```
