...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/patents/serp-header.desktop');
...
const scriptSrc = `${staticData.BASE_PATH}patents/serp-header/serp-header-base.desktop.client.js`
```
