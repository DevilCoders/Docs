...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/web4/serp-header.desktop');
...
const scriptSrc = `${staticData.BASE_PATH}web4/serp-header/serp-header-base.desktop.client.js`
```
