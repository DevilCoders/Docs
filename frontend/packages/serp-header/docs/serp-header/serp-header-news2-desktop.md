...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/news2/serp-header.desktop');
...
const scriptSrc = `${staticData.BASE_PATH}news2/serp-header/serp-header-base.desktop.client.js`
```
