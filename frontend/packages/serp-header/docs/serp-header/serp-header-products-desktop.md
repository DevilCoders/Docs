...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/products/serp-header.desktop');
...
const scriptSrc = `${staticData.BASE_PATH}products/serp-header/serp-header-base.desktop.client.js`
```
