...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/news-turbo/serp-header.desktop');
...
const scriptSrc = `${staticData.BASE_PATH}news-turbo/serp-header/serp-header-base.desktop.client.js`
```
