...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/collections/serp-header.desktop');
...
const scriptSrc = `${staticData.BASE_PATH}collections/serp-header/serp-header-base.desktop.client.js`
```
