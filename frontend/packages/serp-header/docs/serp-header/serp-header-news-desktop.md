...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/news/serp-header.desktop');
...
const scriptSrc = `${staticData.BASE_PATH}news/serp-header/serp-header-base.desktop.client.js`
```
