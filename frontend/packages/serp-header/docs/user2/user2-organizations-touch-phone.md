...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/organizations/user2.touch-phone');
...
const scriptSrc = `${staticData.BASE_PATH}organizations/user2/user2-base.touch-phone.client.js`
```
