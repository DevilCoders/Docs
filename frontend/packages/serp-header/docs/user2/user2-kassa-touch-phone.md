...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/kassa/user2.touch-phone');
...
const scriptSrc = `${staticData.BASE_PATH}kassa/user2/user2-base.touch-phone.client.js`
```
