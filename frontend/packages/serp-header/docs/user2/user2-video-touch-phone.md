...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/video/user2.touch-phone');
...
const scriptSrc = `${staticData.BASE_PATH}video/user2/user2-base.touch-phone.client.js`
```
