...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/mail/user2.touch-phone');
...
const scriptSrc = `${staticData.BASE_PATH}mail/user2/user2-base.touch-phone.client.js`
```
