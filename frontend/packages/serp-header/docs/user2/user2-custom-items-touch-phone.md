...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/custom-items/user2.touch-phone');
...
const scriptSrc = `${staticData.BASE_PATH}custom-items/user2/user2-base.touch-phone.client.js`
```
