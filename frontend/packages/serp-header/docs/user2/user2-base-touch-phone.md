...
### Использование
```javascript
const dist = require('@yandex-lego/serp-header/dist/base/user2.touch-phone');
...
const scriptSrc = `${staticData.BASE_PATH}base/user2/user2-base.touch-phone.client.js`
```
