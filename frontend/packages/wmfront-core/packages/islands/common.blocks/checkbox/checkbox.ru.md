...
| [checkboxAttrs](#field-checkboxAttrs) | `Object` | Произвольный набор HTML-атрибутов для элемента [control](#elem-control). |
        ...
        body: [
            {
                ...
                text: 'Чекбокс с многострочной подписью, display: inline-table'
            }
        ]
    },
    {
...
[
    {
        block: 'x-table',
        head: ['Поле checkboxAttrs'],
        body: [
            {
                block: 'checkbox',
                mods: { theme: 'normal', size: 'm' },
                checkboxAttrs: { autofocus: true, id: 'the-id', name: 'the-name', value: 'the-value' },
                text: 'checkbox'
            }
        ]
    },
