...
![suggest](http://jing.yandex-team.ru/files/tenorok/screen01_2014-03-27_20-30-25.png)
...
[suggest2-detect](../suggest2-detect/suggest2-detect.ru.md)      | Блок для сбора данных о браузере пользователя.<br> **NB** _Необходимо [явно декларировать](https://github.yandex-team.ru/lego/islands/blob/dev/common.blocks/suggest2/suggest2.examples/20-large.bemjson.js#L74) в BEMJSON блока._
...
![all-items](http://jing.yandex-team.ru/files/tenorok/screen01_2014-03-27_20-34-32.png)
