...
| ----------- | ------------------- | ----------------- | -------- |
| [type](#mods-type) | `'arrow'`, `'filter'`, `'kebab'`, `'close'`, `'cross'`, `'cross-websearch'` | `BEMJSON` | Тип иконки. |
| [size](#mods-size) | `'ns', 'xs', 's', 'm', 'n', 'l', 'head'` | `BEMJSON`, `JS` | Размер иконки. |
...
| [glyph](#mods-glyph) | `'carets-v'`, `'type-arrow'`, `'type-check'`, `'type-close'`, `'type-cross'`, `'type-filter'`, `'type-kebab'`, `'type-tick'`, `'x-sign'` | `BEMJSON`, `JS` | Инлайновые SVG-иконки. |
...
Допустимые значения: `'arrow'`, `'filter'`, `'kebab'`, `'close'`, `'cross'`, `'cross-websearch'`.
...
{
    block: 'x-table',
    head: ['arrow', 'filter', 'kebab', 'close', 'cross', 'cross-websearch'],
    body: [
        ['arrow', 'filter', 'kebab', 'close', 'cross', 'cross-websearch'].map(function(type) {
            return {
                block: 'x-area',
                mods: { bordered: 'yes' },
                content: {
...
Допустимые значения: `'ns'`, `'xs'`, `'s'`, `'m'`, `'n'`, `'l'`, `'head'`.

Способ установки: `BEMJSON`, `JS`.

> **Важно!** Модификатор `size` используется не со всеми иконками. В большинстве случаев его определять необязательно. При использовании пользовательских иконок вне компонентов, поддерживающих `size`, требуется указать размеры явно через CSS.

> **Важно!** При использовании кастомных иконок вне контролов, поддерживающих `size`, требуется указать размеры явно через CSS.
...
Допустимые значения: `'carets'`, `'type-arrow'`, `'type-check'`, `'type-close'`, `'type-cross'`, `'type-filter'`, `'type-kebab'`, `'type-tick'`, `'x-sign'`.
...
[
    {
        block: 'x-table',
        head: ['carets-v', 'type-arrow', 'type-check', 'type-close', 'type-cross', 'type-filter', 'type-kebab', 'type-tick', 'x-sign'],
        body: [
            ['carets-v', 'type-arrow', 'type-check', 'type-close', 'type-cross', 'type-filter', 'type-kebab', 'type-tick', 'x-sign'].map(function(glyph) {
                return {
                    block: 'x-area',
                    mods: { bordered: 'yes' },
                    content: {
