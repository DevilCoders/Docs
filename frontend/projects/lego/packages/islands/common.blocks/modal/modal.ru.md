...
Блок используется для создания модального окна.
...
Подробнее о работе со [слоями в popup2](https://github.yandex-team.ru/search-interfaces/frontend/blob/master/projects/lego/packages/islands/common.blocks/popup2/popup2.ru.md#%D0%A0%D0%B0%D0%B1%D0%BE%D1%82%D0%B0-%D1%81%D0%BE-%D1%81%D0%BB%D0%BE%D1%8F%D0%BC%D0%B8-z-index).
...
и скрывать ползунки. В примере блока `modal` находится [доопределение](https://github.yandex-team.ru/search-interfaces/frontend/blob/master/projects/lego/packages/islands/common.blocks/modal/modal.examples/blocks/b-page/b-page.js) для блока `b-page`,
