...
Изменения, вошедшие в релиз islands 5.23.0, разделены на группы:
...
| [tooltip: Пробрасывать в попап zIndexGroupLevel](#ISL-4998)                         | [ISL-4998] | [#3552]          |
...
| i-bem: в _extractModVal используем `.className` вместо `.attr('class')` из jQue… | [ISL-5028] | [#3587] |
...
| popup2: Поправить передачу поля position                                         | [ISL-5005] | [#3560] |
| [popup2: Должен скрываться, если цель вышла за пределы прокрутки](#ISL-4716)     | [ISL-4716] | [#3425] |
| i-bem: починить $.inherit, $.inheritSelf для браузеров без интроспекции          | [ISL-4979] | [#3512] |
| lang-switcher.react: Синхронизировать i-bem и react реализацию примеров          | [ISL-4748] | [#3496] |
...
<a name="ISL-4998"></a>
### [tooltip: Пробрасывать в попап zIndexGroupLevel][ISL-4998]

Теперь, передавая JS-параметры в блок `tooltip`, можно передать параметр `zIndexGroupLevel`, который
будет передан в `popup2`.
...
[LEGO-2101]: https://st.yandex-team.ru/LEGO-2101
[#3378]: https://github.yandex-team.ru/lego/islands/pull/3378
...
[DOC-4201]: https://st.yandex-team.ru/DOC-4201
[#3600]: https://github.yandex-team.ru/lego/islands/pull/3600
[ISL-5028]: https://st.yandex-team.ru/ISL-5028
[#3587]: https://github.yandex-team.ru/lego/islands/pull/3587
[LEGO-2119]: https://st.yandex-team.ru/LEGO-2119
[#3566]: https://github.yandex-team.ru/lego/islands/pull/3566
...
[ISL-5005]: https://st.yandex-team.ru/ISL-5005
[#3560]: https://github.yandex-team.ru/lego/islands/pull/3560
[ISL-4998]: https://st.yandex-team.ru/ISL-4998
[#3552]: https://github.yandex-team.ru/lego/islands/pull/3552
[ISL-4716]: https://st.yandex-team.ru/ISL-4716
[#3425]: https://github.yandex-team.ru/lego/islands/pull/3425
[LEGO-2110]: https://st.yandex-team.ru/LEGO-2110
[#3534]: https://github.yandex-team.ru/lego/islands/pull/3534
[#3518]: https://github.yandex-team.ru/lego/islands/pull/3518
[#3484]: https://github.yandex-team.ru/lego/islands/pull/3484
[ISL-4979]: https://st.yandex-team.ru/ISL-4979
[#3512]: https://github.yandex-team.ru/lego/islands/pull/3512
