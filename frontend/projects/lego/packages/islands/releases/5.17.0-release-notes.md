...
Изменения, вошедшие в релиз islands 5.17.0, разделены на группы:
...
| popup2: Неправильно рассчитывается положение, если цель находится внутри …       | [ISL-4591] | [#2932] |
...
<a name="ISL-4589"></a>
### [i-bem__dom: Прокидывать дополнительные данные DOM-события в liveBindTo][ISL-4589]

В `i-bem` добавлена возможность получения дополнительных данных для DOM-события.

Передадим дополнительные данные при инициации события средствами jQuery:
```js
$(...).trigger('event', { a: 100, b: 200 });
```

Получим эти данные в обработчике DOM-события блока:
```js
this.liveBindTo('event', function(e, data) {
    console.log(data); // { a: 100, b: 200 }
});
```
...
[ISL-4589]: https://st.yandex-team.ru/ISL-4589
[#2924]: https://github.yandex-team.ru/lego/islands/pull/2924
[ISL-4492]: https://st.yandex-team.ru/ISL-4492
[#2899]: https://github.yandex-team.ru/lego/islands/pull/2899
[ISL-4513]: https://st.yandex-team.ru/ISL-4513
[#2855]: https://github.yandex-team.ru/lego/islands/pull/2855
...
[ISL-4591]: https://st.yandex-team.ru/ISL-4591
[#2932]: https://github.yandex-team.ru/lego/islands/pull/2932
