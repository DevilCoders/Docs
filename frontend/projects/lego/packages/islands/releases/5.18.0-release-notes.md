...
Изменения, вошедшие в релиз islands 5.18.0, разделены на группы:
...
| [m-suggest-item: Добавить навигационные ссылки](#ISL-4546)                | [ISL-4546] | [#3000] |
...
| popup2: исправить  TypeError в консоли после клика по кнопке в попапе (клик зак… | [ISL-4641] | [#3009], [#3023] |
| radio-button.react: Добавить импорт size_n                                       | [ISL-4638] | [#2998]          |
| select2_type_radio: У control неправильное значение при ошибочных входных данных | [ISL-3782] | [#2956]          |
...
<a name="ISL-4546"></a>
### [m-suggest-item: Добавить навигационные ссылки][ISL-4546]

В блоке `m-suggest-item` был добавлен модификатор `type` в значении `nav`. Теперь блок `m-suggest` может отображать
...
[ISL-4546]: https://st.yandex-team.ru/ISL-4546
[#3000]: https://github.yandex-team.ru/lego/islands/pull/3000
...
[ISL-4641]: https://st.yandex-team.ru/ISL-4641
[#3009]: https://github.yandex-team.ru/lego/islands/pull/3009
[#3023]: https://github.yandex-team.ru/lego/islands/pull/3023
[ISL-4638]: https://st.yandex-team.ru/ISL-4638
[#2998]: https://github.yandex-team.ru/lego/islands/pull/2998
[ISL-3782]: https://st.yandex-team.ru/ISL-3782
[#2956]: https://github.yandex-team.ru/lego/islands/pull/2956
