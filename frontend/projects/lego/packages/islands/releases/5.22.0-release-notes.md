...
Изменения, вошедшие в релиз islands 5.22.0, разделены на группы:
...
| [popup2: Добавить поля tailSize и hasTail в i-bem](#ISL-4715)                 | [ISL-4715] | [#3306] |
...
| i-bem: Упростить код i18n                                                      | [ISL-4894] | [#3328] |
| i-ua: оптимизировать код установки ориентации устройства                       | [ISL-4965] | [#3488] |
...
<a name="ISL-4715"></a>
### [popup2: Добавить поля tailSize и hasTail в i-bem][ISL-4715]

В блок `popup2` в `i-bem`-реализации добавлены bemjson-поля `hasTail` и `tailSize`.
Поле `hasTail` в значении `true` включает отображение хвостика. Значение по умолчанию - `false`.
Размер хвостика по умолчанию - `10px`. Поле `tailSize` позволяет его переопределить. Переданный размер должен иметь значение, кратное `2px`.
...
[ISL-4894]: https://st.yandex-team.ru/ISL-4894
[#3328]: https://github.yandex-team.ru/lego/islands/pull/3328
...
[ISL-4965]: https://st.yandex-team.ru/ISL-4965
[#3488]: https://github.yandex-team.ru/lego/islands/pull/3488
...
[ISL-4715]: https://st.yandex-team.ru/ISL-4715
[#3306]: https://github.yandex-team.ru/lego/islands/pull/3306
