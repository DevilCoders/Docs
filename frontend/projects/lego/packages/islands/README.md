...
## Обратная связь
  ...
  * Slack: [lego-team.slack.com](https://lego-team.slack.com)
  * FAQ: [https://lego.yandex-team.ru/doc/guidelines/faq/](https://lego.yandex-team.ru/doc/guidelines/faq/)
...
## Документация
  ...
  * Документация на Lego-on-React и другая полезная информация:
  <br> https://wiki.yandex-team.ru/lego/

## Миграция (migration guides)

Руководство по миграции [islands 3.х → 4.х](https://github.yandex-team.ru/lego/islands/blob/dev/releases/4.0.0-migration.md)
Руководство по миграции [islands 4.х → 5.х](https://github.yandex-team.ru/lego/islands/blob/dev/releases/5.0.0-migration.md)
Руководство по миграции [islands 5.х → 6.х](https://github.yandex-team.ru/lego/islands/blob/dev/releases/6.0.0-migration.md)
...
- Полный цикл проверок автоматическими тестами, которые включают в себя:
  - Unit-тесты на JS
  - Тесты шаблонов
  - Функциональное тестирование верстки скриншотами ([hermione])
- Ручное тестирование.
...
В частности, там доступны [инструкции по сборке примеров, документации и запуску тестов](https://lego.yandex-team.ru/doc/practics/unit-tests/).
