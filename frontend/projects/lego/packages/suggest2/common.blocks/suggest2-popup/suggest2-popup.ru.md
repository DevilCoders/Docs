...
------------------- | ----------------------
`popup`             | **deprecated** Адаптер API для блока [popup](https://github.yandex-team.ru/search-interfaces/frontend/blob/master/projects/lego/packages/islands/common.blocks/popup/popup.ru.md).
`popup2`            | Адаптер API для блока [popup2](https://github.yandex-team.ru/search-interfaces/frontend/blob/master/projects/lego/packages/islands/common.blocks/popup2/popup2.ru.md). <br> **NB** Для корректного поиска блока `popup2`, необходимо указать JS-параметр блоку [suggest2-form](../suggest2-form/suggest2-form.ru.md): ```js: {popupName: 'popup2'}```.
