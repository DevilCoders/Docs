...
Для добавления специальных типов специфичных для вашего проекта или для ускорения разработки, в компонент можно передать свои обработчики использую TS Generic.
