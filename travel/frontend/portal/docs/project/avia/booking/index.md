...
**Book on Yandex** (BoY) — бронирование и покупка авиабилетов в сервисе Яндекс.Путешествия (без редиректа на сайт партнера)

**офер -> ордер -> покупка -> happy page**

**Ордер/Заказ (order)** - отражает процесс оформления покупки билета

**Страница покупки** - страница оформления покупки заказа

**Happy page** - страница успешного ордера/заказа
