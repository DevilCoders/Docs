...
`error(type ,content)` - показывает уведомление переданного типа (строка 'info' / 'error'/ 'warning' / 'success') с переданным контентом уведомления. К качетсве контента принимает строку или BEMJSON-объект.
