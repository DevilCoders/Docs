...
This document describes some points about contribution process for api-site.
...
```bash
git clone git@github.yandex-team.ru:maps/photo-admin.git ~/www/photo-admin
cd ~/www/photo-admin
# Local machine setup.
make local
# Install i18n
...
The local stand will be available at `https://api-site.dev.yandex.ru:8080/`.
