...
This document describes some points about contribution process for project.
...
The local stand will be available at `https://$USER.toloka.dev.yandex.ru:8080`.
...
To release `production` environment run the following command:
```bash
