...
This document describes some points about contribution process for auth-landing.

The maintainer of the project is Daniil Amirkhanov <doni-rio@yandex-team.ru>.
...
To deploy current configuration to `production` environment run `npx qtools deploy production`.
