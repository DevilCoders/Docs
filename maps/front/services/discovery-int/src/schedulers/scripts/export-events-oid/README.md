...
Export all active events data to yt.

## Reactor

| Environment | URL |
|---|---|
| Testing | https://reactor.yandex-team.ru/browse/resolve?path=%2Fmaps%2Ffront%2Fdiscovery-int%2Fschedulers%2Fexport-events-oid-testing |
| Production | https://reactor.yandex-team.ru/browse/resolve?path=%2Fmaps%2Ffront%2Fdiscovery-int%2Fschedulers%2Fexport-events-oid-production |
