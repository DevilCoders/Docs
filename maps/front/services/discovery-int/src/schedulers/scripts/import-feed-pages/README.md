...
This script loads feed from YT table and converts it into pages.

## Reactor

| Environment | URL |
|---|---|
| Testing | https://reactor.yandex-team.ru/browse/resolve?path=%2Fmaps%2Ffront%2Fdiscovery-int%2Fschedulers%2Fimport-feed-pages-testing |
| Production | https://reactor.yandex-team.ru/browse/resolve?path=%2Fmaps%2Ffront%2Fdiscovery-int%2Fschedulers%2Fimport-feed-pages-production |
