...
Regular update for maintaing relevant state of rubrics in discovery database.

## Reactor

| Environment | URL |
|---|---|
| Testing | https://reactor.yandex-team.ru/browse/resolve?path=%2Fmaps%2Ffront%2Fdiscovery-int%2Fschedulers%2Frewrite-yt-rubrics-testing |
| Production | https://reactor.yandex-team.ru/browse/resolve?path=%2Fmaps%2Ffront%2Fdiscovery-int%2Fschedulers%2Frewrite-yt-rubrics-production |
