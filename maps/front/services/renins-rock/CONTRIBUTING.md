...
This document describes some points about contribution process for renins-rock.

The project is being developed within community. Maintainer merges pull-requests, fixes critical bugs.

See extended data about contributing at spec-projects [README](https://a.yandex-team.ru/arc_vcs/maps/front/docs/spec-projects)
## Codestyle
...
The local stand will be available at `https://renins-rock.dev.yandex.ru:8080`.
...
```bash
testing is being released on each trunk commit, alternatively, you can run:
