...
This document describes some points about contribution process for photo-admin.

The project is being developed within community. Maintainer merges pull-requests, fixes critical bugs.

## Codestyle

See [Yandex Maps](https://github.com/ymaps/codestyle) and [inner](https://github.yandex-team.ru/islets/codestyle) codestyle guides.

## Install

Before start installation you have to make sure that there is `yatool` on your local machine. Read more about this tool [here](https://wiki.yandex-team.ru/yatool/). To install it please follow [the guides](https://wiki.yandex-team.ru/yatool/distrib/).
...
The local stand will be available at https://photo-admin.dev.c.maps.yandex-team.ru:8080.
...
The project has two environments: `testing` and `production`. To deploy the current configuration to environment
run `make release-${environmentName}`.
