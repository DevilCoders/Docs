...
[resources tab in ABC](https://abc.yandex-team.ru/services/maps-front-quotateka-admin/resources/) and create
three new TVM resources named
- `maps-front-quotateka-admin-prod`
- `maps-front-quotateka-admin-test`
- `maps-front-quotateka-admin-dev`

The secrets content is located by [Vault](https://vault.yandex-team.ru/) links contained in
`maps-front-quotateka-admin-prod` and `maps-front-quotateka-admin-test` resources you have just created.
...
The last resource `maps-front-quotateka-admin-dev` is used for authorization in developing mode. The point is that
...
`maps-front-quotateka-admin-dev` resource and `self_tvm_id` is its id.
