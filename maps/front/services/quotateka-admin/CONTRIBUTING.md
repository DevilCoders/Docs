...
This document describes some points about contribution process for quotateka-admin.
...
The local stand will be available at `https://quotateka.dev.c.maps.yandex.ru:8080`.
