# Routing for a single courier

A request to this resource builds a route for a courier while taking the traffic conditions and delivery periods into account.
