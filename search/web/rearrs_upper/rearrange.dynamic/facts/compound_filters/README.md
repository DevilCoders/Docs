## Файл конфигурации составного фильтра фактов
...
- создать новый файл и залить его в Sandbox командой `ya upload --do-not-remove compound_filter_config.json`
- полученный `Created resource id` указать в файле `ya.make` в этой директории
- раскатить `rearrange.dynamic` в продакшн
