...
Usage:
1. Build alembic:
run `ya make alembic` from `search/mon/warden`
...
Created migrations are located at `search/mon/warden/migrations/versions`. Name of current created migration will be at the output of alembic run.
