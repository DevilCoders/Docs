...
* [main cfgexample](main_cfgexample.md)	 - Generates config full exmaple
* [main completion](main_completion.md)	 - Generates bash completion scripts
* [main doc](main_doc.md)	 - Generate documentation
* [main serve](main_serve.md)	 - Start API server
* [main version](main_version.md)	 - Print version
