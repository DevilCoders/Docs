...
Это внутренний форк плагина для ydb: [yandex-cloud/jaeger-ydb-store](https://github.com/yandex-cloud/jaeger-ydb-store)
Основные изменения в сборке collector (без grpc-плагина): см. [cmd/collector](cmd/collector)

## тестирование

env:
```
YDB_ADDRESS=ydb-ru.yandex.net:2135
YDB_TOKEN=<oauth token>
YDB_PATH=/ru/home/<username>/mydb
YDB_FOLDER=tests
```
...
```bash
gh workflow run release -f docker_tag=<tag>
```
