...
2. ```ya upload --type=MARKET_FORECAST_SBX  --owner MARKET {tar_gz_name}```
...
<pre>
```
dmitrykondr@laptop:~$ curl -sD- localhost:2606/ping
HTTP/1.1 200 OK
...
<pre>
```
dmitrykondr@laptop:~$ curl -sD- localhost:2606/status
HTTP/1.1 200 OK
Server: gunicorn/19.6.0
