...
<m:attribute required="true"
    ...
    <m:title>
        <c:value>Инвентарный номер</c:value>
    </m:title>
    <m:type xsi:type="a:string"/>
</m:attribute>
```
...
<m:attribute versioned="true"
    ...
    <m:title>
        <c:value>Ответственный сотрудник</c:value>
    </m:title>
    <m:type xsi:type="a:string"/>
</m:attribute>
```
...
<m:attribute>
    <m:code>price</m:code>
    <m:title>
        <c:value>Цена</c:value>
    </m:title>
    <m:type xsi:type="a:decimal"/>
</m:attribute>
```
...
<m:attribute xmlns:a="urn:jmf:attribute:type:default:config:1.0"
    ...
    <m:title>
        <c:value>Ответственные сотрудники</c:value>
    </m:title>
    <!-- Ссылаемся на объекты метакласса employee -->
...
<m:attribute>
    ...
    <m:title>
        <c:value>Время начала работы</c:value>
    </m:title>
    <m:type xsi:type="a:time"/>
</m:attribute>
```
...
<m:attribute xmlns:a="urn:jmf:attribute:type:default:config:1.0"
    ...
    <m:title>
        <c:value>Время создания</c:value>
    </m:title>
...
<m:attribute>
    ...
    <m:title>
        <c:value>Нормативное время обработки</c:value>
    </m:title>
    <m:type xsi:type="a:duration"/>
</m:attribute>
```
