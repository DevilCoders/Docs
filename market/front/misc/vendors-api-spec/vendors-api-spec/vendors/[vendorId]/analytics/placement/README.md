## PUT /vendors/[vendorId]/analytics/placement

Изменение размещения (включение/выключение) услуги "Маркет.Аналитика" для указанного вендора
...
### Ответ:
  ...
  - result `<Object>`
    - **item** `<Object>`
      - **placement** `ACTIVE|SUSPENDED|REJECTED` - текущий статус услуги Маркет.Аналитика (ACTIVE - опубликована, SUSPENDED - распубликована, REJECTED - публикация приостановлена по другим причинам)
