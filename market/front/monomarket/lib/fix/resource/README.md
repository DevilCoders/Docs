[![oko health](https://oko.yandex-team.ru/badges/repo.svg?repoName=market/monomarket&vcs=github&repoFilter=lib/fix/resource)](https://oko.yandex-team.ru/github/market/monomarket?repoFilter=lib/fix/resource) [![oko health](https://oko.yandex-team.ru/badges/pkg.svg?pkgName=@yandex-int/nodules-resource)](https://oko.yandex-team.ru/pkg/@yandex-int/nodules-resource)
 ...
 * async (using [Vow](https://github.com/dfilatov/vow) promises);
 ...
 * `{String} logId` Resource id for logging purposes. Defaults to the name of resource file and name of the method, joined with comma.
 ...
 * `{String} servant` The key listed in Application config. Options from this path in config will be extended with resource options.
