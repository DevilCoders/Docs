...
**PR:** [#956](https://github.yandex-team.ru/market/monomarket/pull/956)
**Author:** @yatamik **Date:** 2022-03-23

Исправлена опечатка в package.json
...
**PR:** [#163](https://github.yandex-team.ru/market/monomarket/pull/163)
**Author:** @avdotion **Date:** 2021-07-16

@yandex-market/promise-helpers в монорепе!

### Usage

Ничего не поменялось, как и раньше доступны:
* attempt
* props
* spread
...а также typescript-хелперы Awaited и Promisable!

### Migration

Нужна последняя версия @yandex-market/invariant