[BCM2](../README.md) / [Exports](../modules.md) / [http/transport](../modules/http_transport.md) / HttpTransportResponseError

# Class: HttpTransportResponseError

[http/transport](../modules/http_transport.md).HttpTransportResponseError
...
- [constructor](http_transport.httptransportresponseerror.md#constructor)

### Properties

- [headers](http_transport.httptransportresponseerror.md#headers)
- [message](http_transport.httptransportresponseerror.md#message)
- [requestId](http_transport.httptransportresponseerror.md#requestid)
- [stack](http_transport.httptransportresponseerror.md#stack)
- [statusCode](http_transport.httptransportresponseerror.md#statuscode)
- [statusMessage](http_transport.httptransportresponseerror.md#statusmessage)
- [url](http_transport.httptransportresponseerror.md#url)
- [prepareStackTrace](http_transport.httptransportresponseerror.md#preparestacktrace)
- [stackTraceLimit](http_transport.httptransportresponseerror.md#stacktracelimit)

### Accessors

- [name](http_transport.httptransportresponseerror.md#name)

### Methods

- [captureStackTrace](http_transport.httptransportresponseerror.md#capturestacktrace)

## Constructors

### constructor

\+ **new HttpTransportResponseError**(`request`: [*HttpTransportRequest*](../modules/http_transport_types.md#httptransportrequest), `response`: [*HttpTransportRawResponse*](../modules/http_transport_types.md#httptransportrawresponse)): [*HttpTransportResponseError*](http_transport.httptransportresponseerror.md)
...
`response` | [*HttpTransportRawResponse*](../modules/http_transport_types.md#httptransportrawresponse) |

**Returns:** [*HttpTransportResponseError*](http_transport.httptransportresponseerror.md)

Overrides: [HttpTransportError](http_transport.httptransporterror.md)

Defined in: lib/lib/bcm2/src/http/transport.ts:102
