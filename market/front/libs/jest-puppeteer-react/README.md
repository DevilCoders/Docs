Forked form [jest-puppeteer-react](https://github.com/hapag-lloyd/jest-puppeteer-react#8.2.0) because we need jest-environment-puppeteer-jsdom instead of jest-environment-puppeteer for screenshot tests.
