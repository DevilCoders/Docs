...
**Неправильно:**
```js
import '@self/platform/widgets/core/Switcher';
import '@self/platform/widgets/parts/SomeCase';
```
...
```js
import {switchCase} from '@self/platform/widgets/core/Switcher/actions';
