...
4. [Клиентский DC](/client/desktop.modules/n-DataCollector/n-DataCollector.js) инициализируется ключом из предыдущего пункта.
...
Инициализация:
```javascript
this.module(require('app/modules/DataCollector'), {
