# Резолвер addUgcVideoComment

## Описание

Резолвер, который создает комментарий на видео. Необходима авторизация.
...
- [Входные параметры](https://github.yandex-team.ru/market/marketfront/blob/master/market/platform.touch/api/app/handlers/addUgcVideoComment/v2/index.js#L24)
