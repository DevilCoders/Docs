# Резолвер resolvePostComments

## Описание

Резолвер, который возвращает комментарии на пост.
Обязательный параметр:

| Parameter | Type | Description | Default | Value |
| ----------- | -------- | ----------------------- | ----- | ----- |
| `postId` | number | Ид поста | - | - |
...
- [Входные параметры](https://github.yandex-team.ru/market/marketfront/blob/master/market/api/app/handlers/resolvePostComments/v2/index.js#L35)
