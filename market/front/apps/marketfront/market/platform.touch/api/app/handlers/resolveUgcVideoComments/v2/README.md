# Резолвер resolveUgcVideoComments

## Описание

Резолвер, который возвращает комментарии на видео.
Обязательный параметр:

| Parameter | Type | Description | Default | Value |
| ----------- | -------- | ----------------------- | ----- | ----- |
| `videoId` | number | Ид поста | - | - |
...
- [Входные параметры](https://github.yandex-team.ru/market/marketfront/blob/master/market/api/app/handlers/resolveUgcVideoComments/v2/index.js#L35)
