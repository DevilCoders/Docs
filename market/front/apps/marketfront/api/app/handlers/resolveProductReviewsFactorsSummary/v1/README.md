# Резолвер resolveProductReviewsFactorsSummary
...
- [Входные параметры](https://github.yandex-team.ru/market/marketfront/blob/master/api/app/handlers/resolveProductReviewsFactorsSummary/v1/constraints.js)
