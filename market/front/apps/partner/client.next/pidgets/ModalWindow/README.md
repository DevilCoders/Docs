...
export const CASHBACK_MODAL_ID = createModalId('MyPidget:edit');
```
...
Пример:
```js
import {modalAction} from 'shared/collections/abstractModal/actions';
import {CASHBACK_MODAL_ID} from '~/pidgets/MyPidget/constants'
