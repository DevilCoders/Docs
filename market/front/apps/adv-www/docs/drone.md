...
1. [Установите Drone CLI клиент](https://wiki.yandex-team.ru/drone/guides/cli-client/)
...
1. В списке найдите _advertising/adv-front_ и активируйте
...
История сборок будет доступна на [странице проекта](https://drone.yandex-team.ru/advertising/adv-front).
