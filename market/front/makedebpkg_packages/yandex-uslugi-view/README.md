...
Пакет с сервисом http://uslugi.yandex.ru, который на данный момент закрыт.

Содержит только заглушку о том что сервиса больше нет.
...
Этот пакет нужно загрузить в репозиторий [common][repo-link].
...
[repo-link]: https://github.yandex-team.ru/market/packages/blob/master/README.md#common
