yandex-market-x5-view-export
----------------

Пакет для выкладки содержимого репозитория [export](https://github.yandex-team.ru/market/export), который доступен по адресу http://market.yandex.ru/export/
