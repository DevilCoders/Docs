# factorRejectAlfaYtImportExecutor
...
Джоба ежедневно выгружает из YT список клиентов, которых проверил Альфа-Банк.

### Датафлоу
Выгружаем все данные из таблицы в YT - `//home/market/production/billing/dictionaries/factoring/factor_reject_alfa_result`
...
На 5ое июля 2022 года эта джоба ожидаемо падает, т.к. Альфу не включили еще (инфа от Кости)
Поэтому правильным решением дежурного будет даунтаймить на неделю
