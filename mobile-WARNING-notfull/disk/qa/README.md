...
9. Устанавливаем библиотеку для работы со ST `pip3 install -i https://pypi.yandex-team.ru/simple/ yandex-mobmail-tracker-api-client`
10. Устанавливаем библиотеку для работы со TestPalm`pip3 install -i https://pypi.yandex-team.ru/simple yandex_tp_api_client`

--
Для запуска Run_Nightly нужно установить:
1. Устанавливаем библиотеку **lxml** командой в терминале `pip install lxml`
