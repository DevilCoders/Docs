...
- Monitoring UI
  ...
  1. Нажмите кнопку ![img](../../_assets/share-light.svg =25x25) *Поделиться* (*Share*) в левом верхнем углу.
  1. Переключитесь на вкладку *Data API*.
  1. Скопируйте команды для соответствующего запроса в консоль и выполните команду.

    !["Блок «Поделиться» в Monitoring UI"](../../_assets/monitoring-ui-data-api.png "Блок «Поделиться» в Monitoring UI")
...
- Solomon UI
  ...
  1. Скопируйте команды из блока *Data API commands* в консоль и выполните команду.
    ...
    ![Блок 'Share...' в Solomon UI](../../_assets/solomon-ui-data-api.png "Блок 'Share...' в Solomon UI")
