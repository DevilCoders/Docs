...
Для сервисов, запущенных в RTC и собирающих метрики в [кластера Solomon Production/Prestable/Testing](overview/clusters.md), можно использовать порт из диапазона 3400-3499 и не заказывать дополнительные сетевые доступы.
...
| Solomon Cloud Preprod | `_C_CLOUD_PREPROD_SOLOMON_CORE_` | [Создать заявку](https://puncher.yandex-team.ru?create_sources=_C_CLOUD_PREPROD_SOLOMON_CORE_&create_protocol=tcp&create_locations=office&create_locations=vpn&create_comment=Solomon%20Cloud%20Prerod%20собирает%20метрики%20в%20pull-режиме)
