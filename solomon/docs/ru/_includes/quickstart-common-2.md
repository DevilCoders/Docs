...
![Заполненная форма создания cluster](_assets/quickstart_metrics_create_cluster.png "Заполненная форма создания cluster")
<small>Рисунок 3 — Заполненная форма создания кластера.</small>

![Заполненная форма добавления хоста в кластер](_assets/quickstart_metrics_create_cluster_hosts.png "Заполненная форма добавления хоста в кластер")
...
![Заполненная форма создания шарда](_assets/quickstart_metrics_create_shard.png "Заполненная форма создания шарда")
...
![Экран статуса сбора метрик](_assets/quickstart_metrics_shard_status.png "Экран статуса сбора метрик")
